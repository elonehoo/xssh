    ...
    pub(crate) fn tr(self, key: TextKey) -> &'static str {
        match self {
            Self::Zh => match key {
                ...
                TextKey::TabReady => "Tab 已就绪",
                TextKey::ConnectionIntro => "连接页已打开，SSH 会话层后续接入。",
                ...
                TextKey::AuthenticationInfo => "认证方式",
                TextKey::PasswordSaved => "已保存密码",
                TextKey::Settings => "设置",
                TextKey::Theme => "主题",
            ...
            Self::En => match key {
                ...
                TextKey::TabReady => "Tab ready",
                TextKey::ConnectionIntro => "Connection page is open. SSH sessions come next.",
                ...
                TextKey::AuthenticationInfo => "Authentication",
                TextKey::PasswordSaved => "password saved",
            ...
            Self::Ja => match key {
                ...
                TextKey::TabReady => "Tab 準備完了",
                TextKey::ConnectionIntro => {
                    "接続ページを開きました。SSH セッションは次に接続します。"
                }
                ...
                TextKey::AuthenticationInfo => "認証方式",
                TextKey::PasswordSaved => "パスワード保存済み",
                TextKey::Settings => "設定",
                TextKey::Theme => "テーマ",
